  ...
  const services = [
    {
      ...
      desc: "目的を達成するための手段として、大きな効果をもたらすことを目指し、使う人の立場を常に考えたデザインを提案、設計させていただきます。",
    },
    {
      jaName: "Web制作",
      enName: "Web Coding",
      ...
      desc: "デザインの意図を理解し、動きや効果を適切に使用したWebサイトを提供します。レスポンシブ対応やWordPressなど更新性の高いサイトやヘッドレスCMSを利用したサイトなど、Webサイトの特性に合った様々な開発の対応が可能です。",
    },
    {
      jaName: "業務効率化",
      ...
      desc: "ファイル操作、大量の情報の取得、操作など、日々の決まったルーティーン、マンパワーが必要とされる業務を自動化することで、コストの削減、利益拡大へとつなげるソリューションを提供します。",
    },
  ]
