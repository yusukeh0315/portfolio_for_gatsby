        ...
        <section className="l-main-works">
          <div className="l-main-works__inner">
            ...
            <div className="p-cards-works p-cards-works--col3">
              <div className="p-cards-works__item c-card-works"><motion.a onClick={() => handleOpenModal(0)} className="c-card-works__link js-modal__open" href data-target="modal01">
                  <figure className="c-card-works__img-wrapper"><img className="c-card-works__img" alt="写真：実績" src="/images/portfolio.png" /></figure></motion.a></div>
              {/* /.c-card-works*/}
              <div className="p-cards-works__item c-card-works"><motion.a onClick={() => handleOpenModal(1)} className="c-card-works__link js-modal__open" href data-target="modal02">
                  <figure className="c-card-works__img-wrapper"><img className="c-card-works__img" alt="写真：実績" src="/images/coding01.png" /></figure></motion.a></div>
              {/* /.c-card-works*/}
              <div className="p-cards-works__item c-card-works"><motion.a onClick={() => handleOpenModal(2)} className="c-card-works__link js-modal__open" href data-target="modal03">
                  <figure className="c-card-works__img-wrapper"><img className="c-card-works__img" alt="写真：実績" src="/images/coding02.png" /></figure></motion.a></div>
              {/* /.c-card-works*/}
              <div className="p-cards-works__item c-card-works"><motion.a onClick={() => handleOpenModal(3)} className="c-card-works__link js-modal__open" href data-target="modal04">
                  <figure className="c-card-works__img-wrapper"><img className="c-card-works__img" alt="写真：実績" src="/images/wpcustom-thumbnail.png" /></figure></motion.a></div>
              {/* /.c-card-works*/}
              <div className="p-cards-works__item c-card-works"><motion.a onClick={() => handleOpenModal(4)} className="c-card-works__link js-modal__open" href data-target="modal05">
                  <figure className="c-card-works__img-wrapper"><img className="c-card-works__img" alt="写真：実績" src="/images/coding04.png" /></figure></motion.a></div>
              {/* /.c-card-works*/}
              <div className="p-cards-works__item c-card-works"><motion.a onClick={() => handleOpenModal(5)} className="c-card-works__link js-modal__open" href data-target="modal06">
                  <figure className="c-card-works__img-wrapper"><img className="c-card-works__img" alt="写真：実績" src="/images/sample_thumbnail.png" /></figure></motion.a></div>
              {/* /.c-card-works*/}
              {/* /.p-cards-works*/}
              {/* /.main-works__inner*/}
            </div>
